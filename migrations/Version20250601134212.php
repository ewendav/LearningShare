...
final class Version20250601134212 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO `user` (id, email, roles, password, firstname, lastname, biography, avatar_path, phone, balance) VALUES
            (1, 'admin@learningshare.com', '[\"ROLE_ADMIN\"]', '$adminPassword', 'Admin', 'System', 'Administrateur de la plateforme LearningShare', 'uploads/avatars/avatar-default.png', '0666666666', 1000),
            (2, 'alice.martin@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Alice', 'Martin', 'Passionnée de programmation et de musique', 'uploads/avatars/avatar-default.png', '0123456789', 150),
            (3, 'bob.dupont@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Bob', 'Dupont', 'Chef cuisinier amateur, j\\'adore partager mes recettes', 'uploads/avatars/avatar-default.png', '0234567890', 200),
            (4, 'claire.bernard@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Claire', 'Bernard', 'Professeure d\\'anglais freelance', 'uploads/avatars/avatar-default.png', '0345678901', 75),
            (5, 'david.rousseau@example.com', '[\"ROLE_USER\"]', '$userPassword', 'David', 'Rousseau', 'Musicien professionnel, piano et guitare', 'uploads/avatars/avatar-default.png', '0456789012', 120),
            (6, 'emma.leclerc@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Emma', 'Leclerc', 'Développeuse web full-stack', 'uploads/avatars/avatar-default.png', '0567890123', 180),
            (7, 'francois.moreau@example.com', '[\"ROLE_USER\"]', '$userPassword', 'François', 'Moreau', 'Coach sportif spécialisé en tennis', 'uploads/avatars/avatar-default.png', '0678901234', 90),
            (8, 'gabrielle.lambert@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Gabrielle', 'Lambert', 'Artiste peintre et professeure de dessin', 'uploads/avatars/avatar-default.png', '0789012345', 110),
            (9, 'henri.simon@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Henri', 'Simon', 'Étudiant en informatique, passionné de Python', 'uploads/avatars/avatar-default.png', '0890123456', 50),
            (10, 'isabelle.garcia@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Isabelle', 'Garcia', 'Polyglotte, parle 5 langues couramment', 'uploads/avatars/avatar-default.png', '0901234567', 160),
            (11, 'julien.petit@example.com', '[\"ROLE_USER\"]', '$userPassword', 'Julien', 'Petit', 'Mathématicien et pâtissier du dimanche', 'uploads/avatars/avatar-default.png', '0912345678', 130)");
